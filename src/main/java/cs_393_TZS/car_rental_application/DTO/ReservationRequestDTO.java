...
public class ReservationRequestDTO {
    ...
    public ReservationRequestDTO(Long carBarcode, int dayCount, Long memberId, Long pickUpLocationCode, Long dropOffLocationCode, List<Long> additionalEquipmentIds,
